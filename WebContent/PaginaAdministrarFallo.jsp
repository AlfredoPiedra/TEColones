	...
	<body>
		...
		<div class="modal-wrapper" id="popup">
			<div class="popup-contenedor">
				...
				<h2>Otorgar privilegios de administrador!</h2>
				<p>No se pudo otorgar el permiso. Favor intente de nuevo.</p>
	            ...
	            <div class=info>
	                <div class="CajaAdm">
	                    ...
	                    <form action="PrivilegeServlet">
	                    	...
	                    	<select name="funcionarioElegido" id="posiblesAdministradores" value="( selecione el funcionario )">
